...
from simpler_model.models.entity_key import EntityKey
...
class Entity(BaseModel):
    ...
    key: Optional[EntityKey]
    related_entities: List[EntityLink] = Field(alias="relatedEntities")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["url", "name", "type", "attributes", "key", "relatedEntities"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('strong', 'weak'):
            raise ValueError("must be one of enum values ('strong', 'weak')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "key": EntityKey.from_dict(obj.get("key")) if obj.get("key") is not None else None,
            "relatedEntities": [EntityLink.from_dict(_item) for _item in obj.get("relatedEntities")] if obj.get("relatedEntities") is not None else None
        })
